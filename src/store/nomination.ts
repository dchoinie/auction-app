...
interface NominationState {
  ...
  setSnakingDirection: (isSnakingBack: boolean) => void;
}

export const useNominationStore = create<NominationState>()((set) => ({
  ...
  setSnakingDirection: (isSnakingBack) => set({ isSnakingBack }),
}));
